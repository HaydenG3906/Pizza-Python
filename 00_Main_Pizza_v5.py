...
Enter Payment Details if paying with credit card (For the assessment instead of entering a real card
...
print("Pizza Ordered: {}".format(pizza_types_name))
...
while selectpizza != "0":
    ...
    while pizzamodificaton == "yes":
        ...
        while True:
            ...
            if selectpizzanum > pizza_wanted or selectpizzanum < 0:
...
if confirm == "no":
    ...
    if confirm == "yes":
        ...
        print("Receipt printed to {}".format(filename))
    else:
        print(bcolors.FAIL + "Order Was Deleted")
        exit()
